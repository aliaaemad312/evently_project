...
abstract class AppLocalizations {
  ...
  /// No description provided for @please_enter_valid_password.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @please_add_description.
  ///
  /// In en, this message translates to:
  /// **'Please add description'**
  String get please_add_description;
